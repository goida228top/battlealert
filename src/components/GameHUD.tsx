...
export const GameHUD: React.FC<GameHUDProps> = ({ gameState, engineRef, setGameState }) => {
  ...
  return (
    <div className="w-[220px] lg:w-[280px] h-full shrink-0 bg-zinc-950 border-l-2 border-zinc-800 flex flex-col shadow-[-10px_0_40px_rgba(0,0,0,0.8)] relative z-20 overflow-hidden">
      {/* Scanline Effect */}
