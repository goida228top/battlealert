  ...
  return (
    <div className="absolute inset-0 z-[200] flex flex-col bg-[url('/assets/soviet_base.png')] bg-cover bg-center overflow-y-auto">
      ...
      <div className="relative z-10 flex-1 flex flex-col p-2 md:p-4 max-w-6xl mx-auto w-full min-h-0">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-2 md:gap-4 min-h-0 overflow-y-auto md:overflow-visible">
        ...
        {/* Bottom Bar */}
        <div className="mt-2 md:mt-4 flex flex-col md:flex-row justify-between items-center w-full gap-2 md:gap-4 shrink-0 pb-1 md:pb-2">
          <button 
